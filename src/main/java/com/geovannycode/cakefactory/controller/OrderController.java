...
import com.geovannycode.cakefactory.entity.OrderItem;
import com.geovannycode.cakefactory.entity.PendingPayment;
import com.geovannycode.cakefactory.entity.BasketItem;
import com.geovannycode.cakefactory.entity.AddressPayment;
import com.geovannycode.cakefactory.repository.Basket;
import com.geovannycode.cakefactory.service.PaymentService;
...
public class OrderController {
    ...
    String createOrder(@RequestParam String addressLine1, @RequestParam String addressLine2, @RequestParam String postcode, HttpServletRequest request) {
        AddressPayment address = AddressPayment.builder().line1(addressLine1).line2(addressLine2).postcode(postcode).build();
    ...
    private String buildAddress(String addressLine1, String addressLine2, String postcode) {
        return Arrays.asList(addressLine1, addressLine2, postcode).stream().collect(Collectors.joining(", "));
    }
